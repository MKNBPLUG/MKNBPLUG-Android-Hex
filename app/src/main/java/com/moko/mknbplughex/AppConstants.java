...
public class AppConstants {
    ...
    // action
    public static final String ACTION_FINISH_ACTIVITY = "com.moko.mknbplughex.action.finishActivity";
    public static final String ACTION_MODIFY_NAME = "com.moko.mknbplughex.action.ACTION_MODIFY_NAME";
    public static final String ACTION_DELETE_DEVICE = "com.moko.mknbplughex.action.ACTION_DELETE_DEVICE";
    public static final String ACTION_DEVICE_STATE = "com.moko.mknbplughex.action.ACTION_DEVICE_STATE";
    // sp
    public static final String SP_NAME = "sp_name_hex";
