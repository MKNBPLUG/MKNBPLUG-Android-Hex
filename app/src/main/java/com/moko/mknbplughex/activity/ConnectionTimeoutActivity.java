...
import com.moko.mknbplughex.databinding.ActivityConnectionTimeoutBinding;
...
public class ConnectionTimeoutActivity extends BaseActivity<ActivityConnectionTimeoutBinding> {
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (cmd == MQTTConstants.MSG_ID_CONNECTION_TIMEOUT && flag == 0) {
            ...
            mBind.etConnectionTimeout.setText(String.valueOf(MokoUtils.toInt(data)));
        }
    ...
    public void onSave(View view) {
        ...
        if (isValid()) {
            String connectionTimeoutStr = mBind.etConnectionTimeout.getText().toString();
