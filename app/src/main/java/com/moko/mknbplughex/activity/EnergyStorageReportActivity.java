...
public class EnergyStorageReportActivity extends BaseActivity {
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (cmd == MQTTConstants.MSG_ID_ENERGY_REPORT_PARAMS && flag == 0) {
            ...
            if (dataLength != 4)
                return;
            etEnergyStorageInterval.setText(String.valueOf(data[0] & 0xFF));
            etPowerChangeThreshold.setText(String.valueOf(data[1] & 0xFF));
            etEnergyReportInterval.setText(String.valueOf(MokoUtils.toInt(Arrays.copyOfRange(data, 2, 4))));
        }
